...
const UOMS = ['pcs', 'kg', 'g', 'l', 'ml', 'box', 'pack', 'bottle', 'can', 'bag'];
const blank = { item_code: '', description: '', category: '', uom: 'pcs', is_perishable: false, track_batches: false, default_min_qty: 0, default_reorder: 0, is_active: true };
        ...
        <Modal title={edit.id ? 'Edit item' : 'New item'} onClose={() => setEdit(null)}>
          <form onSubmit={save} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <Select label="UoM" value={edit.uom} onChange={(e) => setEdit({ ...edit, uom: e.target.value })}>
