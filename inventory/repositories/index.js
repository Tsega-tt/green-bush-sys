...
const { stores, capabilities, items, suppliers, thresholds, usersRepo, servingSizes, uoms } = require('./masterRepo');
...
const { acceptance } = require('./acceptanceRepo');

module.exports = {
  balances, batches, ledger, priceHistory,
  stores, capabilities, items, suppliers, thresholds, usersRepo, servingSizes, uoms,
